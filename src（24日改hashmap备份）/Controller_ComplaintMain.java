...
public class Controller_ComplaintMain {
    ...
    public void click_NewButton(){
        ...
        try{
            ...
            //controller_complaintNewRecord.setDialogStage(Stage_ComplaintNewRecord);
            controller_complaintNewRecord.setCount(count);
            //单号计数+1
            count++;
            //监听"投诉单管理-新增"窗口如果按窗口右上角X退出，清空ObservableList内数据并重新从数据库获取，消除因新增
    ...
    public void click_EditButton(){
        ...
        try{
            ...
            Edit_Stage.setTitle("小区物业管理系统-投诉单-修改");
            ...
            Controller_ComplaintEditRecord controller = loader.getController();
            controller.setDialogStage(Edit_Stage);
            controller.setdata_ComplaintTable(Complaint_TableView.getSelectionModel().getSelectedItem());
        }
        catch (Exception e) {
            e.printStackTrace();
        }
