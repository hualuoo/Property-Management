...
public class Controller_OwnerEditRecord_EditFamily {
    String FNo;
    ...
    public void setFame(String FName){
        FName_TextField.setText(FName.trim());
    }
    public void setFSex(String FSex){
        FSex_ChoiceBox.setValue(FSex.trim());
    }
    public void setFTel(String FTel){
        FTel_TextField.setText(FTel.trim());
    }
    public void setFID(String FID){
        FID_TextField.setText(FID.trim());
    }
    public void setFRelation(String FReation){
        FRelation_TextField.setText(FReation.trim());
    }
    public void setFNote(String FNote){
        FNote_TextArea.setText(FNote);
    }
    public void initialize(){
        //初始化
        //将"业主信息管理 - 家庭成员信息 - 编辑"控制器保存到map中
        StageManager.CONTROLLER.put("Controller_OwnerEditRecord_EditFamily", this);
        //ChoiceBox加入选择项
    ...
    public void click_ConfirmButton(){
        ...
        if (FNote_TextArea.getText()==null || FNote_TextArea.getText().length()==0){
            //家庭成员备注为空时
            //添加数据到数据库(家庭成员备注为空)
            editFamilyInfoToSQL_NullFNote();
            //刷新"业主信息管理 - 家庭成员信息"窗口的TableView
            flush_TableView();
            //关闭"业主信息管理 - 家庭成员信息 - 修改"窗口
            close_Windows();
        }
        else {
    ...
    void editFamilyInfoToSQL_NullFNote(){
        //修改数据库数据(家庭成员备注为空)
        query = "UPDATE Family_Info\n" +
                "SET FName=\'" + FName_TextField.getText() + "\',FSex=\'" + FSex_ChoiceBox.getSelectionModel().getSelectedItem() + "\',FTel=\'" + FTel_TextField.getText() + "\',FID=\'" + FID_TextField.getText() + "\',FRelation=\'" + FRelation_TextField.getText() + "\',FNote=NULL\n" +
                "WHERE FNo=" + FNo;
        SQL_Connect sql_connect = new SQL_Connect();
        sql_connect.sql_Update(query);
    }
    void editFamilyInfoToSQL_FullFNote(){
        //修改数据库数据(家庭成员备注不为空)
        query = "UPDATE Family_Info\n" +
                "SET FName=\'" + FName_TextField.getText() + "\',FSex=\'" + FSex_ChoiceBox.getSelectionModel().getSelectedItem() + "\',FTel=\'" + FTel_TextField.getText() + "\',FID=\'" + FID_TextField.getText() + "\',FRelation=\'" + FRelation_TextField.getText() + "\',FNote=\'" + FNote_TextArea.getText() + "\'\n" +
                "WHERE FNo=" + FNo;
        SQL_Connect sql_connect = new SQL_Connect();
        sql_connect.sql_Update(query);
    }
    ...
    void close_Windows(){
        //关闭"业主信息管理 - 家庭成员信息 - 修改"窗口
        //remove"业主信息管理 - 家庭成员信息 - 修改"窗口和其控制器
        StageManager.STAGE.remove("Stage_OwnerEditRecord_EditFamily");
