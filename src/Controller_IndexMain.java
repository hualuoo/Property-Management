...
public class Controller_IndexMain {
    ...
    public void click_NewButton() {
        ...
        try{
            ...
            loader.setLocation(Controller_IndexMain.class.getResource("GUI_IndexNewHouse.fxml"));
    ...
    public void click_EditButton(){
        if(House_TableView.getSelectionModel().getSelectedIndex() < 0){
            ...
            try{
                Stage Edit_Stage;
                FXMLLoader loader = new FXMLLoader();
                loader.setLocation(Controller_IndexMain.class.getResource("GUI_IndexEditHouse.fxml"));
                AnchorPane page = (AnchorPane) loader.load();
